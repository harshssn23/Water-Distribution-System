...
// Construct string with hyphens
      const outputHTML = `<h3><p><br />The distance between the Source and the Destination is: ${x} km. <br /> <br /> 
       The cost of pumping the water is: ${Math.round(result[2])} Rs. <br /> <br />
       The path for optimal distribution of water is: ${locationString.substring(23)}</p></h3>`;
      outputContainer.innerHTML = outputHTML;

  
      // const outputHTML = `<h3><p><br />The distance between the Source and the Destination is: ${x} km. <br /> <br /> 
      // The cost of pumping the water is: ${Math.round(result[2])} Rs.</p><h3>`;
      // // const outputHTML = `<p>The value of the distance is: ${x}</p>`;
